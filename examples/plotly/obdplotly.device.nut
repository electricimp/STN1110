...
// subscribe the logger to various vehicle parameters and update at 0.2 Hz (once every 5 seconds)
car.getEngineRPM(0.2, logger.subscribe("rpm"))
car.getVehicleSpeed(0.2, logger.subscribe("speed"))
car.getThrottlePosition(0.2, logger.subscribe("throttle"))
car.getEngineRuntime(0.2, logger.subscribe("runtime"))
car.getCoolantTemperature(0.2, logger.subscribe("coolant_temp"))
car.getIntakeAirTemperature(0.2, logger.subscribe("intake_temp"))
car.getFuelPressure(0.2, logger.subscribe("fuel_pressure"))
// handle any errors
